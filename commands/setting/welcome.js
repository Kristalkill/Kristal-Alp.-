module.exports = {
  ...
  async execute(Main, message, args) {
    Guild.findOne({guildID: message.guild.id}, (err, Data) => {
      ...
      .addField('**Изменение Статуса -**',`**${Data.Moderation.prefix}welcome status (on или off)**`,true)
      .addField('**Изменение Заголовка -**',`**${Data.Moderation.prefix}welcome Title текст**`,true)
      .addField('**Изменение Заголовка -**',`**${Data.Moderation.prefix}welcome Description текст**`,true)
      .addField('**Изменение Заголовка -**',`**${Data.Moderation.prefix}welcome Channel упоминание канала**`,true)
      .addField('**Информация о всем -**',`**${Data.Moderation.prefix}welcome**`,true)
      .addField("** **", '**Информация**')
