module.exports = {
  ...
  async execute(Main, message, args) {
    Guild.findOne({guildID: message.guild.id}, (err, Data) => {
      ...
      .addField('**Изменение Статуса -**',`**${Data.prefix}leave status (on или off)**`,true)
      .addField('**Изменение Заголовка -**',`**${Data.prefix}leave Title текст**`,true)
      .addField('**Изменение Заголовка -**',`**${Data.prefix}leave Description текст**`,true)
      .addField('**Изменение Заголовка -**',`**${Data.prefix}leave Channel упоминание канала**`,true)
      .addField('**Информация о всем -**',`**${Data.prefix}leave**`,true)
      .addField("** **", '**Информация**')
