      ...
      try{
       ...
       Promise.all(promises).then(results => { 
        ...
        message.channel.send(Botinfoembed
          ...
          .addField(
            `**Техническая**`, `>>> **<:cpu:709750871692542142> | CPU:** ${results[0].reduce((var1, var2) => var1 + var2, 0).toFixed(2)}%
            **<:ram:709751455610961972> | RAM:**  ${this.Main.utils.formatBytes(results[1].reduce((var1, var2) => var1 + var2, 0))} 
          ...
          .addField(
          `**👥 | Социальная**`, `>>> **:man_artist_tone3:Пользователей**  ${results[5].reduce((var1, var2) => var1 + var2, 0)}
          **🌐 | Серверов:**  ${results[3].reduce((var1, var2) => var1 + var2, 0)}
          **🗨 | Каналов:**  ${results[2].reduce((var1, var2) => var1 + var2, 0)}
          **🤣 | Емодзи:**  ${results[4].reduce((var1, var2) => var1 + var2, 0)}`, true))
      });
      } catch (error) {
        console.log(error)
      }}}
